...
<?php endforeach; ?>
 <?php endif; ?>
            ...
            <?php endif; ?>
<?php if(PaymethodData::getByName("mp")->is_active):?>
              <div class="panel panel-default">
                <div class="panel-heading">
                  <i class="fa fa-bank"></i> MercadoPago
                </div>
<form method="post" action="./?action=updatepmsettings">
                    <table class="table table-bordered">
                      <tbody>
...
<?php endforeach; ?>
 <?php endif; ?>
                        ...
                        <td>
                        <input type="submit"  class="btn btn-success" value="Actualizar Datos MercadoPago">
                        </td>
                        </tr>
                      </tbody>
                    </table>
...
<?php endforeach; ?>
 <?php endif; ?>
                        ...
                        <td>
                        <input type="submit"  class="btn btn-success" value="Actualizar Datos Bancarios">
                        </td>
                        </tr>
                      </tbody>
                    </table>
            ...
            <?php endif; ?>
<?php if(PaymethodData::getByName("oxxo")->is_active):?>
              <div class="panel panel-default">
                <div class="panel-heading">
                  <i class="fa fa-bank"></i> Oxxo Pay
                </div>
<form method="post" action="./?action=updatepmsettings">
                    <table class="table table-bordered">
                      <tbody>
...
<?php endforeach; ?>
 <?php endif; ?>
                        ...
                        <td>
                        <input type="submit"  class="btn btn-success" value="Actualizar Oxxo Pay">
                        </td>
                        </tr>
                      </tbody>
                    </table>
...
<?php if(PaymethodData::getByName("conekta")->is_active):?>
              <div class="panel panel-default">
                <div class="panel-heading">
                  <i class="fa fa-bank"></i> Pago con tarjeta by Conekta
                </div>
<form method="post" action="./?action=updatepmsettings">
                    <table class="table table-bordered">
                      <tbody>
...
<?php foreach($settings as $cat):?>
  <?php 
  if(substr($cat->name, 0,8)=="conekta_"):?>
                        <tr>
                        <td><?php echo $cat->label; ?>
                        </td>
                        <td>
...
<?php endforeach; ?>
 <?php endif; ?>
                        ...
                        <td>
                        <input type="submit"  class="btn btn-success" value="Actualizar Pago con tarjeta">
                        </td>
                        </tr>
                      </tbody>
                    </table>
