    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Agregar Sub Categoria</h4>
        </div>
...
<form class="form-horizontal" role="form" method="post" action="index.php?action=addsubcategory">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
      <select class="form-control" name="category_id" required>
        ...
        <?php foreach(CategoryData::getAllRoot() as $cat):?>
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <button type="submit" class="btn btn-block btn-primary">Agregar Sub Categoria</button>
    </div>
  </div>
</form>
        </div>
            ...
            <h1>Sub Categorias</h1>
                  <a  data-toggle="modal" href="#myModal" class="btn btn-default">Agregar Sub Categoria</a>
<br><br>
            </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <i class="fa fa-th-list"></i> Sub Categorias
                </div>
                <div class="widget-body medium no-padding">
<?php
$categories = CategoryData::getAllSubs();
...
<form class="form-horizontal" role="form" method="post" action="index.php?action=updatesubcategory">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
      <select class="form-control" name="category_id" required>
        <option value="">-- SELECCIONE --</option>
        <?php foreach(CategoryData::getAllRoot() as $catx):?>
        <option value="<?php echo $catx->id; ?>" <?php if($catx->id==$cat->category_id){ echo "selected"; }?>><?php echo $catx->name; ?></option>
      <?php endforeach; ?>
      </select>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
    <input type="hidden" name="_id" value="<?php echo $cat->id; ?>">
