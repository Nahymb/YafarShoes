...
?>
                        <tr>
                        <td>
                        <a href="index.php?view=openbuy&buy_id=<?php echo $b->id; ?>" class="btn btn-xs btn-default">Detalles</a>
                        <a target="_blank" href="../invoice.php?code=<?php echo $b->code; ?>" class="btn btn-xs btn-default">Imprimir</a>
                        </td>
                        <td>#<?php echo $b->id; ?></td>
    ...
    <td><?php echo $coin; ?> <?php $subtotalx=($buy->getTotal()+($buy->getTotal()*($iva/100))); echo number_format($subtotalx-($subtotalx*($discount/100)) ,2,".",","); ?></td>
    <td><?php echo $coin; ?> <?php echo number_format($ship->price ,2,".",","); ?></td>
                        ...
                        <?php if($b->status_id!=3):?>
                            <a href="./?view=buyhistory&id=<?php echo $b->id;?>" class="btn btn-default btn-xs"><i class="fa fa-clock-o"></i></a>
