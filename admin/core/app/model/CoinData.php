...
// partiendo de que ya tenemos creado un objecto CoinData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new CoinData());
	}
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new CoinData());
	}
