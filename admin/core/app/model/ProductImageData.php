...
class ProductImageData {
	public static $tablename = "product_image";
	...
	public function add(){
		$sql = "insert into ".self::$tablename." (title,description,src,product_id) ";
		$sql .= "value (\"$this->title\",\"$this->description\",\"$this->src\",$this->product_id)";
