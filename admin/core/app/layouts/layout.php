...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Yafar Shoes | Dashboard</title>
...
<script src='plugins/fullcalendar/fullcalendar.min.js'></script>
  ...
  <body class="<?php if(isset($_SESSION["admin_id"]) || isset($_SESSION["pacient_id"]) || isset($_SESSION["medic_id"]) ):?>  skin-blue sidebar-mini <?php else:?>login-page<?php endif; ?>" >
    <div class="wrapper">
      <!-- Main Header -->
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>Yafar </b>Shoes</span>
        </a>
...
<div class="user-panel">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="./?view=ships"><i class="fa fa-circle-o"></i> Tipos de Envio</a></li>
            <li><a href="./?view=categories"><i class="fa fa-circle-o"></i> Categorias</a></li>
            <li><a href="./?view=subcategories"><i class="fa fa-circle-o"></i> Sub Categorias</a></li>
            <li><a href="./?view=clients"><i class="fa fa-circle-o"></i> Clientes</a></li>
            <li><a href="./?view=coupons"><i class="fa fa-circle-o"></i> Cupones</a></li>
          </ul>
        </li>
            <li><a href="./?view=sellreport"><i class='fa fa-area-chart'></i> <span>Reportes</span></a></li>
            <li><a href="./?view=slider"><i class='fa fa-th-large'></i> <span>Slider</span></a></li>
            <li><a href="./?view=ratings"><i class='fa fa-star'></i> <span>Calificaciones</span></a></li>
            <li><a href="./?view=questions"><i class='fa fa-question'></i> <span>Preguntas</span></a></li>
    ...
    <?php endif;?>
      ...
      <section class="content">
        ...
        <strong>YafarShoes &copy; 2023 <a href="https://api.whatsapp.com/send?phone=593997046615" target="_blank">YafarShoes</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
<img src="./img/LOGO.png" alt=""> 
      <div class="login-logo">
        <a href=""><b>Yafar</b>shoes</a>
